package labs.DateAndTime.LocalDate;
...
public class LocalDateTest {
    ...
    static LocalDate withAdjuster() {
         ...
         */
        TemporalAdjuster temporalAdjusters = TemporalAdjusters.firstDayOfNextYear ();
        LocalDate l = ld.with (temporalAdjusters);
        return l;
    }
