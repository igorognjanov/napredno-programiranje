package labs.DateAndTime.ZonedDateTime;
...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        return ZonedDateTime.of (LocalDateTime.of (LocalDate.of (2015, 7,10),
                LocalTime.of (2, 14, 25, 0)), ZoneId.of ("Asia/Tokyo"));
    }
    ...
    static String zonedDateTimeFormat() {
         ...
         */
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern ("yyyy_MM_dd_HH_mm_ss_z");
