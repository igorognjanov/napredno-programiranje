package labs.Generici.KompleksniBroevi;
...
class ComplexNumber<T extends Number, U extends Number> implements Comparable<ComplexNumber<T, U>>{
    ...
    public double modul(){
        return Math.sqrt (Math.abs (real.doubleValue () * real.doubleValue () +
    ...
    public String toString() {
        ...
        return String.format ("%.2f%c%.2fi", real.doubleValue (), '+', imaginary.doubleValue ());
    }
